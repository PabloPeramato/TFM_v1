<template>
  <div class="container" :class="{'right-panel-active': rightPanelActive}">
    <div class="form-container sign-up-container">
      <form @submit.prevent="onRegister">
        ...
        <input v-model="registerUsername" type="text" placeholder="Name" />
    ...
    <div class="form-container sign-in-container">
      <form @submit.prevent="onLogin">
        ...
        <input v-model="loginField" type="email" placeholder="Email" />
  ...
  <footer>
    <p>Virtual Hardware Laboratory by Pablo Peramato Benito &copy; 2025</p>
  </footer>
</template>
