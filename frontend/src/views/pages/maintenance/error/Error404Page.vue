  ...
  <v-row no-gutters class="h-screen">
    <v-col class="d-flex align-center justify-center">
      <div class="text-center">
        ...
        <h1 class="text-h1">Algo salió mal</h1>
        <p>
          <small>La página que buscas fue movida, eliminada,<br />renombrada o puede que nunca haya existido.</small>
        </p>
        <v-btn variant="flat" color="primary" class="mt-4" to="/" prepend-icon="mdi-home"> Inicio </v-btn>
      </div>
    </v-col>
  </v-row>
</template>
